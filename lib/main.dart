...
class _Home_State extends State<Home_> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<String> images = ["assets/images/plate3.png","assets/images/plate4.png","assets/images/plate5.png","assets/images/plate6.png"];
    final List<String> names = ["Salmon Bowl","Sping Bowl","Avocado Bowl","Berry Bowl"];
    final List<String> price = ["24.00","22.00","26.00","19.00"];
 ...
 Container(
  ...
  context: context,builder: (_) => NetworkGiffyDialog(
    ...
    title: Text('allah ghaleb ma temchich',
